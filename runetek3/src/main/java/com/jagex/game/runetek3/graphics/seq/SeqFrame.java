...
public class SeqFrame {
    ...
    public static void decode(FileArchive class36) {
        Buffer class35_sub2_sub3 = new Buffer(class36.method417((byte) 6, null, "frame_head.dat"));
        Buffer class35_sub2_sub3_1 = new Buffer(class36.method417((byte) 6, null, "frame_tran1.dat"));
        Buffer class35_sub2_sub3_2 = new Buffer(class36.method417((byte) 6, null, "frame_tran2.dat"));
        Buffer class35_sub2_sub3_3 = new Buffer(class36.method417((byte) 6, null, "frame_del.dat"));
        int j = class35_sub2_sub3.g2();
        int k = class35_sub2_sub3.g2();
        aSeqFrameArray180 = new SeqFrame[k + 1];
        int[] ai = new int[500];
        int[] ai1 = new int[500];
        int[] ai2 = new int[500];
        int[] ai3 = new int[500];
        for (int l = 0; l < j; l++) {
            ...
            SeqFrame class11 = aSeqFrameArray180[i1] = new SeqFrame();
            class11.anInt181 = class35_sub2_sub3_3.g1();
            int j1 = class35_sub2_sub3.g2();
            SeqBase class9 = SeqBase.aSeqBaseArray169[j1];
            class11.aSeqBase_182 = class9;
            ...
            for (int j2 = 0; j2 < k1; j2++) {
                ...
                if (k2 > 0) {
                    if (class9.anIntArray171[j2] != 0) {
                        for (int i3 = j2 - 1; i3 > l1; i3--) {
                            if (class9.anIntArray171[i3] != 0)
                                continue;
                            ai[i2] = i3;
                            ai1[i2] = 0;
                            ai2[i2] = 0;
                    ...
                    ai[i2] = j2;
                    char c = '\0';
                    if (class9.anIntArray171[ai[i2]] == 3)
                        c = '\200';
                    if ((k2 & 1) != 0)
    ...
    public static SeqFrame[] aSeqFrameArray180;
    public int anInt181;
    public SeqBase aSeqBase_182;
    public int anInt183;
